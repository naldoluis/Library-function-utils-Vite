...
public interface Resource<T> {
	...
	ResponseEntity<Book> generateByteQRCode(@PathVariable Long id);

	@GetMapping("/generateImageQRCode/{id}")
	ResponseEntity<Book> generateImageQRCode(@PathVariable Long id);
