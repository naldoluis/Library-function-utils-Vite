...
export default function Slide() {
  return (
      <Carousel style={{ fontSize: 15 }} prevLabel="⮜ Previus" nextLabel="Next ➤" indicators={false}>
        ...
        <h5 style={{ textAlign: "center", fontSize: 17.5 }}>News Page 1</h5>
          <img
        ...
        <Carousel.Item className="slide">
        <h5 style={{ textAlign: "center", fontSize: 17.5 }}>News Page 2</h5>
          <img
            style={{ width: 700, height: 400, margin: "20px 0 0 200px", borderRadius: 10 }}
        ...
        <Carousel.Item className="slide">
        <h5 style={{ textAlign: "center", fontSize: 17.5 }}>News Page 3</h5>
          <img
            style={{ width: 700, height: 400, margin: "20px 0 0 200px", borderRadius: 10 }}
